...
Hashtags are thematic labels that link related articles together. The Hashtags tab shows all available tags, grouped by category.

Tap a hashtag to see all articles that carry that tag. This is a quick way to explore content on a specific theme without browsing the full Library.

---

## Vocabulary (Bookmarks)

The Vocabulary tab is where you build and study your personal word lists.
